...
Route::get('project/{project}/comments/{projectComment}', 'ProjectCommentsController@editComment');
Route::patch('project/{project}/comments/{projectComment}', 'ProjectCommentsController@updateComment');

				...
				<form class="form-horizontal" action="{{url('profile/update')}}" method="POST">
					...
					<fieldset>
						...
						<div class="form-group row">
						    ...
						    <div class="col-md-4">
						        <input type="text" class="form-control" id="date_of_birth" name="date_of_birth" value="{{$user->profile->date_of_birth}}">
						    </div>
						</div>
						<div class="form-group row">
						...
						<div class="form-group row">
							...
							@if ($user->profile->gender) 
								<div class="row">	
								    ...
								    <div class="col-md-1"><input class="radio" type="radio" name="gender" id="male" value="1" checked=""></div>						
								</div>
								<div class="row">	
									<div class="col-md-1"><label class="control-label" for="female">Female</label></div>
								    <div class="col-md-1"><input class="radio" type="radio" name="gender" id="female" value="0"></div>						
								</div>
							@else
								<div class="row">	
									<div class="col-md-1"><label class="control-label" for="male">Male</label></div>
								    <div class="col-md-1"><input class="radio" type="radio" name="gender" id="male" value="1"></div>						
								</div>
								<div class="row">	
									<div class="col-md-1"><label class="control-label" for="female">Female</label></div>
								    <div class="col-md-1"><input class="radio" type="radio" name="gender" id="female" value="0" checked=""></div>						
								</div>
							@endif
						    </div>
						</div>
						<div class="form-group row">
						    ...
						    <div class="col-md-4">
						        <textarea class="form-control" rows="3" id="biography" name="biography" placeholder="{{$user->profile->biography}}"></textarea>
								<grammarly-btn>

							...
							<div class="col-md-3">
								<div class="row">
									<div class="col-md-12 well-lg">
										<div class="center-block project-image"
                             		 		style="background-image: url({{$user->profile->getProfileImagePath()}});">
										</div>
									</div>
								</div>
								<div class="row well-lg">
									<div class="col-md-12">
										<label for="thumbnail" class="col-md-4 control-label">Change Photo</label>
				                		<div class="col-md-8">
				                ...
				                <div class="form-group row">
				                    ...
				                    <div class="col-md-4">
				                        @if ($user->profile->gender)
				                            <div class="row">
				                                <div class="col-md-2"><label class="control-label" for="male">Male</label></div>
				                                <div class="col-md-1"><input class="radio" type="radio" name="gender" id="male"
				                                                             value="1" checked=""></div>
				                            </div>
				                            <div class="row">
				                                <div class="col-md-2"><label class="control-label" for="female">Female</label></div>
				                        ...
				                        @else
				                            ...
				                            <div class="row">
				                                <div class="col-md-2"><label class="control-label" for="female">Female</label>
				                                </div>
				                                <div class="col-md-1"><input class="radio" type="radio" name="gender"

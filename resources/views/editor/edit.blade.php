...
@section('head')
    <title>{{$editor->filename}} | The Squire Project</title>
    ...
    <main class="container editor">
        <div class="row">
            <div class="project-page-elements">
                <a href="/create/{{$editor->projectname}}">
                    <button type="button" id="delete">Create</button>
                </a>
            </div>
            <div class="project-page-elements">
                <a href="/rename/{{$editor->projectname}}/{{$editor->filename}}">
                    <button type="button" id="delete">Rename</button>
                </a>
            </div>
            <div class="project-page-elements">
                <a href="/delete/{{$editor->projectname}}/{{$editor->filename}}">
